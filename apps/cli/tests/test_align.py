...
def test_nuc_to_aa_vars_non_codon_aligned_deletion(tmp_path):
    ...
    Codons involved (nucPos values are 0-based):
      aaPos=67 (H): nucPos1=21763, nucPos2=21764, nucPos3=21765
      ...
      aaPos=68 (H): nucPos1=21766, nucPos2=21767, nucPos3=21768
        → all three positions deleted → altAa=="---" → treated as deletion.
      aaPos=69 (V): nucPos1=21769, nucPos2=21770, nucPos3=21771
    ...
    and the output is empty or an incorrect single-AA deletion.
    """
    ...
    # Exactly one CDS deletion must be emitted, spanning both AA 69 and AA 70.
